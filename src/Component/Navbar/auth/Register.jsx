    ...
    <div className="fixed inset-0 bg-black bg-opacity-80 flex justify-center items-center z-50">
      <div className="bg-[#1f1f1f] rounded-lg w-[90%] md:w-[800px] flex flex-col md:flex-row overflow-hidden relative">
        ...
        <div className="w-full md:w-1/2 p-6 text-white">
          ...
          <input type="text" placeholder="Full Name" className="w-full mb-4 p-2 rounded bg-black border border-gray-500" />
          <input type="email" placeholder="Email address" className="w-full mb-4 p-2 rounded bg-black border border-gray-500" />
          <input type="password" placeholder="Password" className="w-full mb-4 p-2 rounded bg-black border border-gray-500" />
          <input type="password" placeholder="Confirm Password" className="w-full mb-4 p-2 rounded bg-black border border-gray-500" />
          ...
          <button onClick={onClose} className="bg-[#FE7C45] w-full py-2 rounded text-black font-semibold hover:scale-105 cursor-pointer">Register</button>

          <hr className="my-4 border-gray-600" />

          <div className="flex justify-center gap-4">
            <span className="text-white text-sm">Or sign up with</span>
          </div>
