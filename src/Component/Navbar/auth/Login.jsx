...
import React from 'react';
import { IoClose } from 'react-icons/io5';
import basketball from '../../../assets/box.png'; // Replace with actual image path
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-80 flex justify-center items-center z-50">
      <div className="bg-[#1f1f1f] rounded-lg w-[90%] md:w-[800px] flex flex-col md:flex-row overflow-hidden relative">
        ...
        <div className="w-full md:w-1/2 p-6 text-white">
          <h2 className="text-2xl font-bold mb-4">Log in</h2>
          <input type="text" placeholder="Email address or user name" className="w-full mb-4 p-2 rounded bg-black border border-gray-500" />
          <input type="password" placeholder="Password" className="w-full mb-4 p-2 rounded bg-black border border-gray-500" />
          ...
          <div className="flex items-center mb-4">
            ...
            <label htmlFor="terms" className="text-sm">By continuing, you agree to the Terms of Use and Privacy Policy</label>
          </div>
          ...
          <p className="text-center text-sm mt-4">
            ...
            <button onClick={switchToRegister} className="ml-1 text-[#FE7C45] underline cursor-pointer">Register</button>
          </p>
